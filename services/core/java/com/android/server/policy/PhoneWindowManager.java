...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.ACCELEROMETER_ROTATION_ANGLES), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mVolBtnMusicControls = (EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.VOLBTN_MUSIC_CONTROLS, 1,
            ...
            boolean threeFingerGesture = EVSettings.System.getIntForUser(resolver,
            ...
            mUserRotationAngles = EVSettings.System.getInt(resolver,
                    EVSettings.System.ACCELEROMETER_ROTATION_ANGLES, -1);
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_ASSIST: {
                ...
                if (down && (mPressOnAssistBehavior == KEY_ACTION_APP_SWITCH
