...
import com.android.systemui.plugins.TriStateUiController;
import com.android.systemui.plugins.TriStateUiController.UserActivityListener;
    ...
    private void updateTriStateLayout() {
        if (mContext != null) {
            ...
            if (res != null) {
                ...
                int triStatePos = res.getInteger(com.evervolv.platform.internal.R.integer.config_alertSliderLocation);
