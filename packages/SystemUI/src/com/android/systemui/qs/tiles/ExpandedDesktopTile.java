...
public class ExpandedDesktopTile extends QSTileImpl<BooleanState> {
    ...
    public Intent getLongClickIntent() {
        return new Intent("com.evervolv.toolbox.EXPANDED_DESKTOP_SETTINGS");
    }
    ...
    public int getMetricsCategory() {
        return EVMetricsLogger.QS_EXPANDED_DESKTOP;
    }
    ...
    protected void toggleState() {
        ...
        try {
            ...
            hasNavigationBar = windowManager.hasNavigationBar(mContext.getDisplayId());
