...
public class ThemeOverlayController implements CoreStartable, Dumpable {
    ...
    private static final String OVERLAY_BERRY_BLACK_THEME =
    ...
    public void start() {
        ...
        mSecureSettings.registerContentObserverForUser(
                EVSettings.System.getUriFor(EVSettings.System.BERRY_BLACK_THEME),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
    ...
    private void updateThemeOverlays() {
        ...
        boolean isBlackMode = (EVSettings.System.getIntForUser(
                mContext.getContentResolver(), EVSettings.System.BERRY_BLACK_THEME,
