...
import vendor.evervolv.biometrics.fingerprint.inscreen.V1_0.IFingerprintInscreen;
import vendor.evervolv.biometrics.fingerprint.inscreen.V1_0.IFingerprintInscreenCallback;
...
public class FODCircleView extends ImageView implements TunerService.Tunable {
    ...
    private static final String FOD_GESTURE = "evsystem:" + EVSettings.System.FOD_GESTURE;
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        if (key.equals(Settings.Secure.DOZE_ENABLED)) {
