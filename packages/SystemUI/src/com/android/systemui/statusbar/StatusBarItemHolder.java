...
import com.evervolv.internal.statusbar.StatusBarItem;

import java.util.ArrayList;

public class StatusBarItemHolder extends RelativeLayout
        implements StatusBarItem.Manager {
    private static final String TAG = "StatusBarItemHolder";

    private ArrayList<StatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<StatusBarItem.DarkReceiver>();
    private ArrayList<StatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<StatusBarItem.VisibilityReceiver>();
    ...
    public StatusBarItemHolder(Context context) {
        this(context, null);
    }

    public StatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(ArrayList<Rect> areas, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (StatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (StatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // StatusBarItem.Manager methods

    public void addDarkReceiver(StatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(StatusBarItem.VisibilityReceiver visibilityReceiver) {
