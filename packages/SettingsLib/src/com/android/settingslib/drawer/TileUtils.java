...
public class TileUtils {
    ...
    private static final String EVERVOLV_SETTINGS_ACTION =
            "com.evervolv.toolbox.action.SETTINGS";
    ...
    public static final String EVERVOLV_SETTING_PKG = "com.evervolv.toolbox";
        ...
        for (UserHandle user : userManager.getUserProfiles()) {
            ...
            if (user.getIdentifier() == ActivityManager.getCurrentUser()) {
                ...
                if (SETTING_PKG.equals(settingPkg)) {
                    getTilesForAction(context, user, EVERVOLV_SETTINGS_ACTION, cache, null, tiles,
                        true, EVERVOLV_SETTING_PKG);
                }
    ...
    private static DashboardCategory createCategory(Context context, String categoryKey,
        ...
        for (ResolveInfo resolved : results) {
            ...
            category.priority = (SETTING_PKG.equals(pkgName) || EVERVOLV_SETTING_PKG.equals(pkgName))
                    ? resolved.priority
                    : 0;
