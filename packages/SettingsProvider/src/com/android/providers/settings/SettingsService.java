    ...
    final static class MyShellCommand extends ShellCommand {
        ...
        static void dumpHelp(PrintWriter pw, boolean dumping) {
            if (dumping) {
                ...
                pw.println("  get [--user <USER_ID> | current] [--evervolv] NAMESPACE KEY");
                pw.println("      Retrieve the current value of KEY.");
                pw.println("  put [--user <USER_ID> | current] [--evervolv] NAMESPACE KEY VALUE [TAG] [default]");
                ...
                pw.println("  delete [--user <USER_ID> | current] [--evervolv] NAMESPACE KEY");
                pw.println("      Delete the entry for KEY.");
                pw.println("  reset [--user <USER_ID> | current] [--evervolv] NAMESPACE {PACKAGE_NAME | RESET_MODE}");
                ...
                pw.println("  list [--user <USER_ID> | current] [--evervolv] NAMESPACE");
